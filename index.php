	...
	<body>
		...
		<script>
			async function loadServerMetrics() {
				...
				const requestHytale = await fetch('/.common/servermetrics.php?server=get_metrics_hytale', {cache: 'no-store'});
				...
				const requestProjectZomboid = await fetch('/.common/servermetrics.php?server=get_metrics_projectzomboid', {cache: 'no-store'});
				...
				const requestVRising = await fetch('/.common/servermetrics.php?server=get_metrics_vrising', {cache: 'no-store'});
